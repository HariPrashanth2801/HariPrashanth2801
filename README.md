...
### Multi-Mode Mecanum Wheel Rover
Developed an omni-directional rover using FreeRTOS and ESP32-CAM with support for concurrent task execution, wireless control, and real-time video streaming.

### Self-Balancing Bot
Implemented a PID-based control system for a two-wheeled self-balancing robot capable of maintaining stability under varying operating conditions.

### Smart Patient Vitals Monitoring System
Built an ESP32-based monitoring platform for tracking vital signs and generating automated alerts during abnormal conditions.
